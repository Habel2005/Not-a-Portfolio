    ...
    <main ref={containerRef} className="bg-[#020813] min-h-screen text-[#F0F4F8] font-body selection:bg-white selection:text-black overflow-x-hidden">
      ...
      <section className="pt-28 pb-20 px-8 md:px-16 lg:px-24 max-w-screen-2xl mx-auto flex flex-col justify-center">
        <div className="kolo-reveal flex items-center gap-3 mb-12 text-primary/60">
          <Smartphone size={14} />
          <span className="text-[10px] font-code tracking-[0.4em] uppercase">Andriod Application</span>
        </div>

        <h1 className="kolo-reveal text-[15vw] font-headline font-bold uppercase tracking-tighter leading-[0.75] mb-20">
          Kolo <br /><span className="italic text-white/10 font-light">Prayer App.</span>
        </h1>
      ...
      {/* Editorial Footer */}
      <footer className="py-24 px-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-[#020813]">
