...
const systemsProjects = [
    { name: "flashflow", tags: ["TypeScript", "Web", "Flashcards"], year: "2024", type: "Fullstack", img: "https://picsum.photos/seed/aura/800/600" },
    { name: "dashboardstudio", tags: ["ERP", "EverGreen Theme", "Data"], year: "2024", type: "System", img: "https://picsum.photos/seed/aura/800/600" },
    { name: "StudentManagement", tags: ["Java", "Backend", "Utility"], year: "2024", type: "Core Logic", img: "https://picsum.photos/seed/aura/800/600" },
];
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-[#050505] text-white font-sans selection:bg-primary selection:text-black">
            <nav className="fixed top-0 left-0 w-full p-8 flex justify-between items-center z-50">
                ...
                <div className="text-[10px] font-code tracking-[0.3em] uppercase text-primary">03 // SYSTEMS_UTILITY</div>
            </nav>
            ...
            <section className="pt-48 px-8 md:px-16 max-w-[1600px] mx-auto pb-32">
                <h1 className="text-6xl md:text-[8vw] font-headline font-bold uppercase tracking-tighter leading-none mb-24">
                    Systems <span className="text-primary italic">Index.</span>
                </h1>
                ...
                <div className="border-t border-white/10">
                    <div className="grid grid-cols-12 gap-4 py-4 border-b border-white/10 text-[10px] font-code uppercase tracking-[0.2em] text-white/40">
                        ...
                        <div className="col-span-4 md:col-span-2">Architecture</div>
